...
function typeWriter() {
  ...
  if (isDeleting) {
    ...
    charIndex--;
    typeSpeed = 150; // Kecepatan menghapus lebih cepat
  } else {
  ...
  typewriterText.innerHTML += '<span class="cursor">l</span>';

  // Cek jika kata sudah selesai diketik
  if (!isDeleting && charIndex === currentText.length) {
    isDeleting = true;
    typeSpeed = 9500; // Diam sebentar setelah selesai mengetik (2 detik)
  } 
